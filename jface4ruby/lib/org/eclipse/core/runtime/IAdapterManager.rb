...
module Org::Eclipse::Core::Runtime
  module IAdapterManagerImports #:nodoc:
  ...
  module IAdapterManager
    include_class_members IAdapterManagerImports
    ...
    class_module.module_eval {
      ...
      # @since org.eclipse.equinox.common 3.3
      const_set_lazy(:NOT_LOADED) { 1 }
      const_attr_reader  :NOT_LOADED
      
      # This value can be returned to indicate that an adapter factory is loaded.
      # @since org.eclipse.equinox.common 3.3
      const_set_lazy(:LOADED) { 2 }
      const_attr_reader  :LOADED
    }
    ...
    # @since 3.1
    def compute_adapter_types(adaptable_class)
    ...
    # given type
    # @since 3.0
    def get_adapter(adaptable, adapter_type_name)
      raise NotImplementedError
    end
