...
module Org::Eclipse::Core::Commands::Operations
  module IOperationApprover2Imports #:nodoc:
  ...
  # 
  # @since 3.2
  module IOperationApprover2
    include_class_members IOperationApprover2Imports
    ...
    def proceed_executing(operation, history, info)
