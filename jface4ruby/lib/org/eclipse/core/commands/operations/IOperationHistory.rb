...
module Org::Eclipse::Core::Commands::Operations
  module IOperationHistoryImports #:nodoc:
    class_module.module_eval {
      include ::Java::Lang
      include ::Org::Eclipse::Core::Commands::Operations
      include_const ::Org::Eclipse::Core::Commands, :ExecutionException
      include_const ::Org::Eclipse::Core::Internal::Commands::Operations, :GlobalUndoContext
  ...
  module IOperationHistory
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:GLOBAL_UNDO_CONTEXT) { GlobalUndoContext.new }
      const_attr_reader  :GLOBAL_UNDO_CONTEXT
      
      # An operation info status describing the condition that there is no
      # available operation for redo.
      const_set_lazy(:NOTHING_TO_REDO_STATUS) { OperationStatus.new(IStatus::INFO, OperationStatus::DEFAULT_PLUGIN_ID, OperationStatus::NOTHING_TO_REDO, "No operation to redo", nil) }
      const_attr_reader  :NOTHING_TO_REDO_STATUS
      
      # $NON-NLS-1$
      # 
      # An operation info status describing the condition that there is no
      # available operation for undo.
      const_set_lazy(:NOTHING_TO_UNDO_STATUS) { OperationStatus.new(IStatus::INFO, OperationStatus::DEFAULT_PLUGIN_ID, OperationStatus::NOTHING_TO_UNDO, "No operation to undo", nil) }
      const_attr_reader  :NOTHING_TO_UNDO_STATUS
      ...
      const_set_lazy(:OPERATION_INVALID_STATUS) { OperationStatus.new(IStatus::ERROR, OperationStatus::DEFAULT_PLUGIN_ID, OperationStatus::OPERATION_INVALID, "Operation is not valid", nil) }
      const_attr_reader  :OPERATION_INVALID_STATUS
    }
    ...
    def dispose(context, flush_undo, flush_redo, flush_context)
      raise NotImplementedError
    end
