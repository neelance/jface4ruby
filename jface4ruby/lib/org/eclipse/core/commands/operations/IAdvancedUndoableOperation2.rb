...
module Org::Eclipse::Core::Commands::Operations
  module IAdvancedUndoableOperation2Imports #:nodoc:
  ...
  # 
  # @since 3.3
  module IAdvancedUndoableOperation2
    include_class_members IAdvancedUndoableOperation2Imports
    ...
    def compute_execution_status(monitor)
