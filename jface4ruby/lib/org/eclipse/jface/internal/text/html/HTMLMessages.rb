...
module Org::Eclipse::Jface::Internal::Text::Html
  module HTMLMessagesImports #:nodoc:
  ...
  # @since 3.3
  class HTMLMessages 
    include_class_members HTMLMessagesImports
    
    class_module.module_eval {
      const_set_lazy(:RESOURCE_BUNDLE) { HTMLMessages.get_name }
    ...
    private
    alias_method :initialize__htmlmessages, :initialize
  end
