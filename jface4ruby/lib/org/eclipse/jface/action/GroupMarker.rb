...
module Org::Eclipse::Jface::Action
  module GroupMarkerImports #:nodoc:
  ...
  class GroupMarker < GroupMarkerImports.const_get :AbstractGroupMarker
    include_class_members GroupMarkerImports
    ...
    private
    alias_method :initialize__group_marker, :initialize
  end
