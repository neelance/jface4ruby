...
module Org::Eclipse::Jface::Viewers
  module ILazyTreeContentProviderImports #:nodoc:
  ...
  # 
  # @since 3.2
  module ILazyTreeContentProvider
    include_class_members ILazyTreeContentProviderImports
    ...
    def update_child_count(element, current_child_count)
      raise NotImplementedError
    end
