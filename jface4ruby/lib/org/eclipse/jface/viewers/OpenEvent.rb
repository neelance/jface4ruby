...
module Org::Eclipse::Jface::Viewers
  ...
  # 
  # @see IOpenListener
  class OpenEvent < OpenEventImports.const_get :EventObject
    include_class_members OpenEventImports
    
    class_module.module_eval {
      # Generated serial version UID for this class.
      # @since 3.1
      const_set_lazy(:SerialVersionUID) { 3761972652973176117 }
    ...
    private
    alias_method :initialize__open_event, :initialize
  end
