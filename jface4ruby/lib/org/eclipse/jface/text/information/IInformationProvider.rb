...
module Org::Eclipse::Jface::Text::Information
  module IInformationProviderImports #:nodoc:
  ...
  # @since 2.0
  module IInformationProvider
    include_class_members IInformationProviderImports
    ...
    def get_subject(text_viewer, offset)
    ...
    def get_information(text_viewer, subject)
      raise NotImplementedError
    end
  end
