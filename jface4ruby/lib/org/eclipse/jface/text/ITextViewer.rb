...
module Org::Eclipse::Jface::Text
  module ITextViewerImports #:nodoc:
  ...
  module ITextViewer
    include_class_members ITextViewerImports
    ...
    def set_text_hover(text_viewer_hover, content_type)
      raise NotImplementedError
    end
    ...
    def set_visible_region(offset, length)
      raise NotImplementedError
    end
    ...
    # @param controlRedraw indicates whether this viewer should manage redraws
    def set_text_color(color, offset, length, control_redraw)
      raise NotImplementedError
    end
