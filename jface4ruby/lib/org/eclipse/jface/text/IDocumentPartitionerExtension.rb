...
module Org::Eclipse::Jface::Text
  module IDocumentPartitionerExtensionImports #:nodoc:
  ...
  # 
  # @since 2.0
  module IDocumentPartitionerExtension
    include_class_members IDocumentPartitionerExtensionImports
