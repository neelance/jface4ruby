...
module Org::Eclipse::Jface::Text
  module ISlaveDocumentManagerImports #:nodoc:
  ...
  # @since 2.1
  module ISlaveDocumentManager
    include_class_members ISlaveDocumentManagerImports
    ...
    def set_auto_expand_mode(slave, auto_expand)
      raise NotImplementedError
    end
  end
