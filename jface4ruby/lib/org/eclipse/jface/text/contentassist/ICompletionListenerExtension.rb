...
module Org::Eclipse::Jface::Text::Contentassist
  module ICompletionListenerExtensionImports #:nodoc:
  ...
  # 
  # @since 3.4
  module ICompletionListenerExtension
    include_class_members ICompletionListenerExtensionImports
    ...
    def assist_session_restarted(event)
