...
module Org::Eclipse::Jface::Text::Formatter
  module IContentFormatterExtensionImports #:nodoc:
  ...
  # @since 3.0
  module IContentFormatterExtension
    include_class_members IContentFormatterExtensionImports
