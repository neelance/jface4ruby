...
module Org::Eclipse::Jface::Text
  module IEditingSupportImports #:nodoc:
  ...
  # @since 3.1
  module IEditingSupport
    include_class_members IEditingSupportImports
    ...
    def is_originator(event, subject_region)
