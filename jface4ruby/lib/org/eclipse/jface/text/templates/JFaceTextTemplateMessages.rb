...
module Org::Eclipse::Jface::Text::Templates
  module JFaceTextTemplateMessagesImports #:nodoc:
  ...
  class JFaceTextTemplateMessages 
    include_class_members JFaceTextTemplateMessagesImports
    
    class_module.module_eval {
      const_set_lazy(:RESOURCE_BUNDLE) { JFaceTextTemplateMessages.get_name }
    ...
    private
    alias_method :initialize__jface_text_template_messages, :initialize
  end
