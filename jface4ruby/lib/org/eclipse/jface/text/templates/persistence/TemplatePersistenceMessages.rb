...
module Org::Eclipse::Jface::Text::Templates::Persistence
  module TemplatePersistenceMessagesImports #:nodoc:
  ...
  class TemplatePersistenceMessages 
    include_class_members TemplatePersistenceMessagesImports
    
    class_module.module_eval {
      const_set_lazy(:RESOURCE_BUNDLE) { TemplatePersistenceMessages.get_name }
    ...
    private
    alias_method :initialize__template_persistence_messages, :initialize
  end
