...
module Org::Eclipse::Jface::Text
  module IDocumentPartitioningListenerExtensionImports #:nodoc:
  ...
  # @since 2.0
  module IDocumentPartitioningListenerExtension
    include_class_members IDocumentPartitioningListenerExtensionImports
    ...
    def document_partitioning_changed(document, region)
