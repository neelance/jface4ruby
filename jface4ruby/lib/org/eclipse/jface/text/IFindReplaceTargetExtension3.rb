...
module Org::Eclipse::Jface::Text
  module IFindReplaceTargetExtension3Imports #:nodoc:
  ...
  # 
  # @since 3.0
  module IFindReplaceTargetExtension3
    include_class_members IFindReplaceTargetExtension3Imports
    ...
    def find_and_select(offset, find_string, search_forward, case_sensitive, whole_word, reg_ex_search)
